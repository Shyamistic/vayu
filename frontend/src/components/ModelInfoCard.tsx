    ...
    <div className="panel p-4 space-y-3">
      ...
      <div className="px-2 py-2.5 rounded-lg" style={{ background: 'rgba(14,165,233,0.05)' }}>
        <div className="flex items-center gap-1 text-[10px] font-mono overflow-x-auto">
          <span className="px-2 py-1 rounded bg-white/5 text-[#22d3ee] whitespace-nowrap">
            Input (17F)
          </span>
          <span className="text-white/30">→</span>
          <span className="px-2 py-1 rounded bg-white/5 text-[#0ea5e9] whitespace-nowrap">
            GATv2Conv(4L)
          </span>
          <span className="text-white/30">→</span>
          <span className="px-2 py-1 rounded bg-white/5 text-violet-400 whitespace-nowrap">
            Transformer(6L)
          </span>
          <span className="text-white/30">→</span>
          <span className="px-2 py-1 rounded bg-white/5 text-emerald-400 whitespace-nowrap">
            Pred Heads
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] text-white/50">Parameters</p>
            <p className="text-xs font-mono font-medium text-white/85">9.5M</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Layers size={11} className="text-white/40" />
          <div>
            <p className="text-[10px] text-white/50">Window</p>
            <p className="text-xs font-mono font-medium text-white/85">45 days</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <GitBranch size={11} className="text-white/40" />
          <div>
            <p className="text-[10px] text-white/50">Graph Nodes</p>
            <p className="text-xs font-mono font-medium text-white/85">1,311</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Database size={11} className="text-white/40" />
          <div>
            <p className="text-[10px] text-white/50">Features</p>
            <p className="text-xs font-mono font-medium text-white/85">17 / node</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/5 pt-2">
        <div className="flex items-center gap-1.5 mb-1.5">
          ...
          <span className="text-[10px] text-white/50 uppercase tracking-wide">Training Data (2010–2025)</span>
        </div>
      ...
      <div className="border-t border-white/5 pt-2">
        <div className="flex items-center gap-1.5 mb-1.5">
          <span className="text-[10px] text-white/50 uppercase tracking-wide">Key Innovations</span>
        </div>
        <ul className="space-y-0.5 text-[10px] text-white/55 list-none">
      ...
      <div className="border-t border-white/5 pt-2">
        <div className="flex items-center gap-1.5 mb-1">
          ...
          <span className="text-[10px] text-white/50 uppercase tracking-wide">References</span>
        </div>
        <div className="space-y-0.5 text-[9px] text-white/40 font-mono">
